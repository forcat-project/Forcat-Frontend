...
export default function Signup() {
  ...
  const steps = [
    ...
    },
    {
      ...
      components: [
        <InputPhoneNumber key="phone" />,
        <InputUserName key="name" />,
      ],
  ...
  useEffect(() => {
    ...
    const userProfileImage = userProfileInfo.startsWith("$")
      ? userProfileInfo.substring(1)
      : userProfileInfo;
    setUserInfo((prev) => ({
      ...prev,
      kakao_id: kakaoId,
  ...
  return (
    <>
      ...
      >
        <Button.Confirm
          onClick={steps[step - 1].onButtonClick}
