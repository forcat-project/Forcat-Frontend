...
export default function CatEdit({ cat, onClose, onReload }: CatEditProps) {
    ...
    const handleResetImage = () => {
        setProfileImage("https://forcat-bucket.s3.amazonaws.com/imgs/3e53742c969111ef86e30242ac140003"); // 프로필 이미지를 null 또는 빈 문자열로 설정하여 기본 이미지로 변경
    ...
    return (
        <StyledModal>
            ...
            <Block.FlexBox direction="column" padding="20px">
                ...
                <StyledTextButton onClick={handleResetImage} style={{ marginBottom: "30px" }}>
                    기본이미지로 변경
                </StyledTextButton>

                <Text.Notice200>이름</Text.Notice200>
                <StyledInput type="text" placeholder="이름" value={name} onChange={e => setName(e.target.value)} />

                <Text.Notice200>품종</Text.Notice200>
                <StyledInput type="text" placeholder="품종" value={breed} onChange={handleBreedChange} />
