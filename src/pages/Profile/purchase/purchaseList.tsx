    ...
    return (
        ...
        >
            {orders.map((order, index) => (
                ...
                >
                    <Block.FlexBox direction="row" justifyContent="space-between" alignItems="center" padding="16px">
                    ...
                    >
                        {order.items.map((item, itemIndex) => (
                            <Block.FlexBox key={itemIndex} direction="row" alignItems="center" padding="16px">
                                ...
                                <Block.FlexBox direction="column" margin="0 0 0 20px" flexGrow="1">
                                    ...
                                    <Text.TitleMenu200>{Number(item.price).toLocaleString()}원</Text.TitleMenu200>
                                </Block.FlexBox>
                            </Block.FlexBox>
                        ))}
                    </Block.FlexBox>
