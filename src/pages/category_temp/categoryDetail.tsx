...
import WithBackAndIconHeader from "../../components/Header_temp/WithBackAndIconHeader";
import {
    MarketContainer,
    ProductGrid,
    ProductCard,
    ...
    SoldoutBox,
    LoadingMessage,
} from "../../components/Product_temp/ProductContainer"; // 공통 Styled Components 가져오기
            ...
            <MarketContainer>
                <ProductGrid>
                    {products.length > 0 ? (
                        ...
                        <LoadingMessage>해당 카테고리에 등록된 상품이 없습니다.</LoadingMessage>
                    )}
                </ProductGrid>
