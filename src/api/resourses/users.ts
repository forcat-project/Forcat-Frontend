...
export const userAPI = {
    ...
    updateUser: (userId: number, userData: IUser) => axiosInstance.put(`/users/${userId}`, userData),
    updateUserPartial: (userId: number, userData: IUser) => axiosInstance.patch(`/users/${userId}`, userData),
