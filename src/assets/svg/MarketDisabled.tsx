...
const SvgMarketDisabled = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#market_disabled_svg__a)">
      <path
        fill="#C9CBD4"
    ...
    <defs>
      <clipPath id="market_disabled_svg__a">
        <path fill="#fff" d="M0 0h56v56H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgMarketDisabled;
