import { Block, Text, Section } from "../../style/ui";
  ...
  return (
    <Block.FlexBox padding="20px">
      <Section>
        ...
        >
          <Text.TitleMenu100 style={{ color: "#A6A9B8", marginRight: "400px" }}>
            상품 금액
          </Text.TitleMenu100>
        ...
        >
          <Text.TitleMenu100 style={{ color: "#A6A9B8", marginRight: "10px" }}>
            포인트
          </Text.TitleMenu100>
          <Text.TitleMenu200 style={{ color: "#333", marginLeft: "20px" }}>
        ...
        >
          ...
          <Text.TitleMenu200 style={{ color: "#F4B647", fontWeight: "600" }}>
            무료
          </Text.TitleMenu200>
        </Block.FlexBox>
        ...
        <Block.FlexBox justifyContent="space-between">
          <Text.TitleMenu200 style={{ fontWeight: "bold" }}>
            총 결제 금액
          </Text.TitleMenu200>
