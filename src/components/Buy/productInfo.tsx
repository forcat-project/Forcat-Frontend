  ...
  return (
    <>
      ...
      {isProductInfoExpanded && products && products.length > 0 && (
        <Block.FlexBox direction="column" padding="20px" gap="15px">
            ...
            return (
              <ProductInform key={index}>
                ...
                <Block.FlexBox direction="column" gap="10px">
                  ...
                  <Block.FlexBox gap="5px" alignItems="center">
                    {product.discount_rate > 0 && (
                      <>
                        <OriginalPrice>
                          {(
                            calculatedOriginalPrice * product.count
                          ).toLocaleString()}
                          원
                        </OriginalPrice>
                        <DiscountRate>
                          {Math.round(product.discount_rate).toLocaleString()}%
                          할인
                        </DiscountRate>
                      </>
                    )}
                  ...
                  <DiscountedPrice>
                    {(
                      Math.round(product.discounted_price) * product.count
                    ).toLocaleString()}
                    원
                  </DiscountedPrice>
                </Block.FlexBox>
