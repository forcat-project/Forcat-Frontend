...
export default function Cats() {
    return (
        <Block.FlexBox padding="20px" direction="column">
            ...
            {/* 두번째 고양이 정보 */}
            <Block.FlexBox direction="row" justifyContent="space-between" padding="20px 20px" alignItems="center">
                {/* 고양이 정보 텍스트 */}
                <Block.FlexBox direction="column">
                    <Text.TitleMenu300 style={{ marginBottom: "10px" }}>냥이</Text.TitleMenu300>
