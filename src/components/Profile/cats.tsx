...
export default function Cats() {
    ...
    const handleSave = (updatedCat: Cat) => {
        ...
        setCats(prevCats => prevCats.map(cat => (cat.name === updatedCat.name ? updatedCat : cat)));
        closeEditModal();
    };
    ...
    return (
        <Block.FlexBox padding="20px" direction="column">
                ...
                >
                    <Block.FlexBox direction="column">
                        ...
                        <Block.FlexBox margin="5px 0">
                            ...
                            <Text.Notice200>{getMonthsFromDays(cat.days_since_birth)}</Text.Notice200>
                        </Block.FlexBox>
                        <Block.FlexBox margin="5px 0">
                            <Text.Notice200 color="Gray" style={{ marginRight: "10px" }}>
                                성별
            ...
            {isEditModalOpen && <CatEdit cat={selectedCat} onClose={closeEditModal} onSave={handleSave} />}
        </Block.FlexBox>
    );
}
